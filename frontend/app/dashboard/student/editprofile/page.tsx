...
// import { ProfileDetailsType, ProfileInitalValue, RadioOptions } from '@/lib/Types';
...
//             <h1 className="mb-4 text-5xl font-semibold">Edit Profile</h1>
//             <GenericForm<ProfileDetailsType>
//               initialValues={ProfileInitalValue}
...
//                         phone: values.phone,
//                     }
//                     const {data} = await api.put("/student/update/profiledetail", {...payload})
//                     console.log(data)
...
export default function EditProfileDetail() {
  ...
  return (
    <div className="min-h-dvh grid place-items-center p-4 bg-gradient-to-br from-indigo-50 via-white to-emerald-50">
      <div className="w-full max-w-md rounded-2xl border shadow-xl border-gray-200 bg-white p-6 ">
